...
class CreateEavEntityType extends Migration
{
    ...
    public function up()
    {
        Schema::create('eav_entity_type', function (Blueprint $table) {
            ...
            $table->char('entity_model')->default(null)->comment('实体模型');
            $table->char('attribute_model')->nullable()->default(null)->comment('属性模型');
            $table->char('entity_table')->nullable()->default(null)->comment('实体表');
            $table->char('value_table_prefix')->nullable()->default(null)->comment('值表前缀');
            $table->char('entity_id_field')->nullable()->default(null)->comment('实体ID字段');
            ...
            $table->char('increment_model')->nullable()->default(null)->comment('增量模型');
            ...
            $table->char('additional_attribute_table')->nullable()->default(null)->comment('额外属性表');
            $table->char('entity_attribute_collection')->nullable()->default(null)->comment('实体属性集合');
