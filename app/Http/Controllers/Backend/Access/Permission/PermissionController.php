...
//    }
    ...
    public function store(StorePermissionRequest $request)
    {
        ...
        return redirect()->route('admin.access.roles.index')->withFlashSuccess(trans('alerts.backend.permissions.created'));
    }
    ...
    public function update($id, UpdatePermissionRequest $request)
    {
        ...
        return redirect()->route('admin.access.roles.index')->withFlashSuccess(trans('alerts.backend.permissions.updated'));
    }
    ...
    public function destroy($id, DeletePermissionRequest $request)
    {
        ...
        return redirect()->route('admin.access.roles.index')->withFlashSuccess(trans('alerts.backend.permissions.deleted'));
    }
}
