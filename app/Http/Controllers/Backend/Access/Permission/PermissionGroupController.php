...
class PermissionGroupController extends Controller
{
    ...
    public function store(StorePermissionGroupRequest $request)
    {
        ...
        return redirect()->route('admin.access.roles.index')->withFlashSuccess(trans('alerts.backend.permissions.groups.created'));
    }
    ...
    public function destroy($id, DeletePermissionGroupRequest $request)
    {
        ...
        return redirect()->route('admin.access.roles.index')->withFlashSuccess(trans('alerts.backend.permissions.groups.deleted'));
    }
