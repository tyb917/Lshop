    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <ul class="nav navbar-nav">
            <li class="{{ Active::pattern('admin/dashboard') }}">
                <a href="{!! route('admin.dashboard') !!}"><span>{{ trans('menus.backend.dashboard') }}</span></a>
            </li>
        </ul>
        <!-- Navbar Right Menu -->
            ...
            <ul class="nav navbar-nav">
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <!-- User Image -->
                                            <img src="{!! access()->user()->avatarImage('30x30') !!}" class="img-circle" alt="User Image"/>
                                        </div>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="{!! access()->user()->avatarImage('30x30') !!}" class="user-image" alt="User Image"/>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="{!! route('auth.logout') !!}">{{ trans('navs.general.logout') }}</a>
                        </li>
                    </ul>
                </li>
            </ul>
