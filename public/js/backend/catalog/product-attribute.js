 ...
 */
var types = {"swatch_visual":["is_unique","is_required","frontend_class","_scope","_default_value","_front_fieldset"],"swatch_text":["is_unique","is_required","frontend_class","_scope","_default_value","_front_fieldset"],"weee":["is_unique","is_required","frontend_class","_scope","_default_value","_front_fieldset"]}
...
var swatchProductAttributes = {
    ...
    switchDefaultValueField: function () {
        ...
        delete types.swatch_visual;
        delete types.swatch_text;
...
$(function () {
    ...
    $('#advance-attribute').collapse('hide');
});
